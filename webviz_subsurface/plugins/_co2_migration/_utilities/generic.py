...
class MapAttribute(StrEnum):
    ...
    MIGRATION_TIME_ALT_SGAS = "Migration time ALT (SGAS)"
    MIGRATION_TIME_ALT_AMFG = "Migration time ALT (AMFG)"
    MIGRATION_TIME_AMFS = "Migration time (AMFS)"
    MIGRATION_TIME_XMFS = "Migration time (XMFS)"
    MIGRATION_TIME_YMFS = "Migration time (YMFS)"
    MIGRATION_TIME_ALT_XMFS = "Migration time ALT (XMFS)"
    MIGRATION_TIME_ALT_YMFS = "Migration time ALT (YMFS)"
...
class MapGroup(StrEnum):
    ...
    MIGRATION_TIME_ALT_SGAS = "SGAS"
    MIGRATION_TIME_ALT_AMFG = "AMFG"
    MIGRATION_TIME_AMFS = "AMFS"
    MIGRATION_TIME_XMFS = "XMFS"
    MIGRATION_TIME_YMFS = "YMFS"
    MIGRATION_TIME_ALT_XMFS = "XMFS"
    MIGRATION_TIME_ALT_YMFS = "YMFS"
...
class MapType(StrEnum):
    ...
    MIGRATION_TIME_ALT_SGAS = "MIGRATION_TIME"
    MIGRATION_TIME_ALT_AMFG = "MIGRATION_TIME"
    MIGRATION_TIME_AMFS = "MIGRATION_TIME"
    MIGRATION_TIME_YMFS = "MIGRATION_TIME"
    MIGRATION_TIME_ALT_XMFS = "MIGRATION_TIME_ALT"
    MIGRATION_TIME_ALT_YMFS = "MIGRATION_TIME_ALT"
...
class MapNamingConvention(StrEnum):
    ...
    MIGRATION_TIME_ALT_SGAS = "migrationtime_sgas_alt"
    MIGRATION_TIME_ALT_AMFG = "migrationtime_amfg_alt"
    MIGRATION_TIME_AMFS = "migrationtime_amfs"
    MIGRATION_TIME_XMFS = "migrationtime_xmfs"
    MIGRATION_TIME_YMFS = "migrationtime_ymfs"
    MIGRATION_TIME_ALT_XMFS = "migrationtime_xmfs_alt"
    MIGRATION_TIME_ALT_YMFS = "migrationtime_ymfs_alt"
